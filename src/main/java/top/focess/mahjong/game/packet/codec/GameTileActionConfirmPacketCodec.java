...
public class GameTileActionConfirmPacketCodec extends PacketCodec<GameTileActionConfirmPacket> {
	@Override
	public @Nullable GameTileActionConfirmPacket readPacket(final PacketPreCodec packetPreCodec) {
	...
	@Override
	public void writePacket(final GameTileActionConfirmPacket packet, final PacketPreCodec packetPreCodec) {
