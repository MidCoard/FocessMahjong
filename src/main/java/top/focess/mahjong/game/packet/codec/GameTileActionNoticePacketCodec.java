...
public class GameTileActionNoticePacketCodec extends PacketCodec<GameTileActionNoticePacket> {
    @Override
    public @Nullable GameTileActionNoticePacket readPacket(final PacketPreCodec packetPreCodec) {
    ...
    @Override
    public void writePacket(final GameTileActionNoticePacket packet, final PacketPreCodec packetPreCodec) {
